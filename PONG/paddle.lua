...
--[[ addition to implement an AI controlled paddle]]
-- move the paddle up based on ball Y position to paddle position
function Paddle:moveUp(ball)
	if ball.y > self.y - 18 then --previously 5
		return true
	else
		return false
	end
...
--move the paddle down based on ball Y position to paddle position
